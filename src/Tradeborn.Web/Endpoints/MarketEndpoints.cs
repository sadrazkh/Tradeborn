...
public static class MarketEndpoints
{
    ...
    {
        var group = app.MapGroup("/api/market").RequireRateLimiting("game");
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            try
            {
                var result = await handler.SellAsync(
                ...
                // A refusal is a 409, not a 400: the request was well-formed, the world just
                // said no. The client shows the reason rather than reporting a bug.
